...
from apps.basicweb.models import Faculty, Major
...
class Student(models.Model):
    ...
    mobile = models.CharField(verbose_name='手机号', max_length=100)
    email = models.EmailField(verbose_name='邮箱地址', max_length=100)
    address = models.CharField(verbose_name='家庭地址', max_length=250)
    faculty = models.ForeignKey(verbose_name='院系名称', to=Faculty, on_delete=models.PROTECT)
    major = models.ForeignKey(verbose_name='专业名称', to=Major, on_delete=models.PROTECT)
